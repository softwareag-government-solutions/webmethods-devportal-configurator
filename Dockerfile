...
ARG SAG_ANSIBLE_ROLES_COMMON_UTILS_RELEASE=1.0.0-4
ARG SAG_ANSIBLE_ROLES_COMMON_UTILS_FILENAME="${SAG_ANSIBLE_ROLES_COMMON_UTILS}-${SAG_ANSIBLE_ROLES_COMMON_UTILS_RELEASE}"

# sag developer portal roles
ARG SAG_ANSIBLE_ROLES_DEVPORTAL=sagdevops-ansible-developer-portal
ARG SAG_ANSIBLE_ROLES_DEVPORTAL_RELEASE=1.0.0-2
ARG SAG_ANSIBLE_ROLES_DEVPORTAL_FILENAME="${SAG_ANSIBLE_ROLES_DEVPORTAL}-${SAG_ANSIBLE_ROLES_DEVPORTAL_RELEASE}"
...
## Role 2: SAG_ANSIBLE_ROLES_DEVPORTAL
RUN set -x \
    && echo "==> Download a specific TAG release of ${SAG_ANSIBLE_ROLES_DEVPORTAL}" \
    && curl -L "${SAG_ANSIBLE_ROLES_URL}/${SAG_ANSIBLE_ROLES_DEVPORTAL}/archive/refs/tags/${SAG_ANSIBLE_ROLES_DEVPORTAL_RELEASE}.tar.gz" -o "/tmp/${SAG_ANSIBLE_ROLES_DEVPORTAL_FILENAME}.tar.gz"  \
...
ENV devportal_wait_connect=true
